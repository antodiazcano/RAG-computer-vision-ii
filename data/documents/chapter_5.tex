...
\begin{figure}[H]
\centering
\includegraphics[scale=0.26]{images/features}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.38]{images/max_act_pat}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.40]{images/gascent}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.52]{images/inverse}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/dfirst}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/dlast}
    \end{minipage}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.75]{images/shap}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.18]{images/occlusion}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.43\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/perro}
    \end{minipage}
    \hfill
    \begin{minipage}{0.47\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/Occlusion}
    \end{minipage}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.95]{images/rise}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.47\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/explanare}
    \end{minipage}
...
where $M$ is the number of steps in the interpolation, typically between 50 and 300.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.53]{images/ig}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{images/cam}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{images/techniques}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/a1}
    \end{minipage}
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/a2}
    \end{minipage}
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/a3}
    \end{minipage}
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/a4}
    \end{minipage}
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/a5}
    \end{minipage}
...
\begin{figure}[H]
    \centering
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/b1}
    \end{minipage}
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/b2}
    \end{minipage}
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/b3}
    \end{minipage}
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/b4}
    \end{minipage}
    \begin{minipage}{0.19\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/b5}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/af}
    \end{minipage}
    \begin{minipage}{0.49\textwidth}
        \includegraphics[width=\linewidth]{images/metrics/bf}
    \end{minipage}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.65]{images/roar}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.87]{images/check2}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.55\textwidth}
        \includegraphics[width=\linewidth]{images/check1a}
    \end{minipage}
    \begin{minipage}{0.44\textwidth}
        \includegraphics[width=\linewidth]{images/check1b}
    \end{minipage}
